...
const countBits = int => {
    ...
    const binarize = intToBinary => { // Function to binarize input. You can't use int.toString(2)
        let intInBinary = '';
    ...
    console.log(`Binary representation of ${originalInteger} is ${binarizedInt}`);
